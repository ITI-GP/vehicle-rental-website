...
//           {/* Backdrop */}
//           <div
//             className="fixed inset-0 z-40 bg-black/60  max-h-[80vh] backdrop-blur-sm transition-opacity duration-300 min-h-screen"
    ...
    <div className="container mt-12 px-6 py-12 bg-gray-50">
      ...
      {showModal && (
        <>
          {/* Backdrop */}
          <div
            className=" mt-12 fixed inset-0 z-40 bg-black/60 backdrop-blur-sm transition-opacity duration-300 min-h-screen"
            onClick={() => setShowModal(false)}
          />
          {/* Modal Panel */}
          <div className="mt-12 fixed inset-0 flex items-center justify-center z-50">
            <div className="bg-white px-6 py-4 rounded-lg shadow-lg w-120 max-h-[90vh] overflow-y-auto">
